...
Application/Startup/startup_stm32g431cbux.o: ../Application/Startup/startup_stm32g431cbux.s Application/Startup/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -c -x assembler-with-cpp -MMD -MP -MF"Application/Startup/startup_stm32g431cbux.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
