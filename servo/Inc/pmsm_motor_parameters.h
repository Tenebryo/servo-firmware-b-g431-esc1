...
#define LS                     0.000025 /* Stator inductance, H
...
/*** Quadrature encoder ***/
#define M1_ENCODER_PPR             15000  /*!< Number of pulses per
                                            revolution */
